            ...
            <div className="list-container">
                <div className="list-settings">
                    ...
                    <div className="radio-buttons-container">
                        <label className={`radio-button ${this.state.show === 'all' ? 'radio-button-active' : null}`} htmlFor="all" >
                            <input type="radio" id="all" checked={this.state.show === 'all'} onChange={() => this.filterList('all')}/>
                            <span>All</span>
                        </label>
                        <label className={`radio-button ${this.state.show === 'complete' ? 'radio-button-active' : null}`} htmlFor="complete">
                            <input
                                type="radio"
                                id="complete"
                        ...
                        <label className={`radio-button ${this.state.show === 'incomplete' ? 'radio-button-active' : null}`} htmlFor="incomplete">
                            <input
                                type="radio"
                                id="incomplete"
